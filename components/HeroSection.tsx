...
export function HeroSection() {
  return (
    <section className="relative overflow-hidden pt-4 pb-20 md:pt-12 md:pb-32 selection:bg-saffron-500 selection:text-white">
      ...
      {/* ═══════ Brand Endorsement Bar ═══════ */}
      <AnimatedSection direction="up" delay={0.05}>
        <div className="max-w-7xl mx-auto px-5 mb-6 md:mb-10">
          <div className="flex items-center justify-center bg-gradient-to-r from-saffron-50 via-white to-saffron-50 border border-saffron-200/60 rounded-2xl sm:rounded-full px-6 py-4 sm:py-5 shadow-[0_4px_20px_rgba(249,115,22,0.12)]">
            <span className="text-2xl md:text-3xl font-black text-transparent bg-clip-text bg-gradient-to-r from-saffron-600 to-saffron-500 tracking-wide uppercase">
              KSE SOLAR ENERGY
            </span>
          </div>
        </div>
      ...
      <div className="max-w-7xl mx-auto px-5 relative z-10 grid md:grid-cols-2 gap-12 items-center">
        ...
        <AnimatedSection direction="left" delay={0.3} className="relative mt-8 md:mt-0 w-full">
          <div className="relative w-full rounded-3xl overflow-hidden shadow-2xl group border border-white/40">
            {/* Gradient overlay */}
