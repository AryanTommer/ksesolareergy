...
export default function ServicesPage() {
  const services = [
    {
      icon: <FaSolarPanel className="text-4xl text-saffron-500 mb-4" />,
      title: "सोलर पैनल इंस्टॉलेशन",
      desc: "छत पर विशेषज्ञ टीम द्वारा सुरक्षित और लंबे समय तक चलने वाला सोलर पैनल इंस्टॉलेशन।",
    },
    {
      icon: <FaBroom className="text-4xl text-emerald-500 mb-4" />,
    ...
    {
      icon: <FaBolt className="text-4xl text-amber-500 mb-4" />,
      title: "इन्वर्टर रिपेयरिंग",
      desc: "सोलर इन्वर्टर की किसी भी तकनीकी समस्या का त्वरित और विश्वसनीय समाधान।",
    },
    {
      icon: <FaBatteryFull className="text-4xl text-rose-500 mb-4" />,
